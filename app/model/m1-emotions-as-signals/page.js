      ...
      <PageLayout
        header={
          <ModelHero
            ...
            description="M1 establishes a foundational claim of TEG-Blue: emotions are biological signals generated by the nervous system in response to detected conditions, not mere byproducts of conscious thought."
      ...
      >
        <article>
          ...
          <section style={{ marginBottom: 48 }}>
            <p style={proseStyle}>
              Before cognition interprets experience, the organism is already evaluating. The nervous system continuously monitors internal and external cues, detects patterns relevant to safety, threat, attachment, loss, and value, and produces signals that orient the body toward response. In this model, those signals are emotions.
            </p>
            <p style={proseStyle}>
              Emotion is therefore treated here as part of the organism{"'"}s primary information system. It is not opposed to reason, nor reducible to subjective feeling. It is a functional output of detection. Cognition enters later, shaping how the signal is interpreted, named, explained, suppressed, or overridden, but not generating the original signal itself.
            </p>
            <p style={proseStyle}>
              This distinction is central to the model. When emotions are treated only as feelings or appraisals, important layers of organization disappear. M1 instead frames emotional experience as a structured process linking detection, physiological activation, and possible restoration. An emotional signal does not merely express a state. It indicates that the nervous system has registered something consequential and has begun reorganizing the organism accordingly.
            </p>
            <p style={proseStyle}>
              Seen this way, the key question is not how emotion should be controlled, but what the signal is indicating and whether the organism has the conditions required to resolve it.
            </p>
            <p style={proseStyle}>
