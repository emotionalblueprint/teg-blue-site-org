      ...
      >
        <article>
          ...
          >
            ...
            <p style={proseStyle}>
              What the child needs is not a caregiver permanently in Connection. It is a caregiver with <strong style={{ color: TEXT.primary }}>State Flexibility</strong> — a nervous system that can access all four states when needed and return to physiological baseline after each. Connection to co-regulate and be present while the child's activation runs. Protection to protect the child from actual danger. Strategic Management to navigate problems the child cannot handle alone. And the return to baseline after each — the system settling back, the body at rest.
            </p>
            <p style={proseStyle}>
              The child does not learn one state. The child learns the movement. A caregiver who can shift into Protection to protect, then settle back to co-regulate the child's fear — that nervous system teaches the child that activation resolves. That all states are temporary because the child witnesses a nervous system that moves through them and returns.
            </p>
            <p style={proseStyle}>
              A caregiver whose nervous system is chronically stuck in any state cannot provide this. A caregiver chronically in Strategic Management may appear regulated — composed, controlled, competent — but the ventral vagal system is suppressed in that state. They can manage the child. They cannot co-regulate with the child. Each stuck caregiver offers only what one state allows, and critically, never models the return to physiological baseline. The child's nervous system never encounters the full range — and never learns that activation is temporary.
            </p>
            <p style={proseStyle}>
          ...
          >
            ...
            <p style={proseStyle}>
              The caregiver's RE is instrumental — reading the child for compliance and control. ER is shut down. SEA is absent. The caregiver's nervous system is chronically organized around Strategic Management or Domination — experienced not as a stuck state but as competence, as maturity.
            </p>
            <p style={proseStyle}>
