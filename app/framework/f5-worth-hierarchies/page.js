      ...
      >
        <article>
          ...
          >
            ...
            <p style={proseStyle}>
              In adulthood, this logic scales. Power becomes compelling — not because humans are shallow, but because power reduces vulnerability by increasing control over access, consequences, and protection. The person pursuing status, validation, or position is not displaying a character flaw. They are running the same regulation logic the nervous system has been running since childhood: find what reduces threat and move toward it.
            </p>
            <p style={proseStyle}>
          ...
          >
            ...
            <ul style={{ paddingLeft: 20, margin: "0 0 24px" }}>
              {[
                ...
                "\"Outcome gaps are often proxy-access artifacts, not evidence of intrinsic differences\"",
