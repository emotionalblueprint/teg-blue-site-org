...
const PAGE_DATES = {
  ...
  '/model/m1-emotions-as-signals': '2026-04-05',
  '/model/m2-nervous-system-states': '2026-04-05',
  ...
  '/framework/f3-false-coherence': '2026-04-05',
  '/framework/f4-rules-regulate': '2026-04-05',
  '/framework/f5-worth-hierarchies': '2026-04-05',
  '/framework/f6-bias-regulates': '2026-04-05',
  '/framework/f7-domination-regulates': '2026-04-05',
  '/framework/f8-repairing-awareness': '2026-04-05',
  '/framework/f9-neurodivergence-variation': '2026-04-05',
...
export default function sitemap() {
  ...
  const staticPages = [
    ...
    {
      url: `${baseUrl}/emotional-somatic-cycle`,
      lastModified: new Date(PAGE_DATES['/emotional-somatic-cycle']),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
    ...
    {
      url: `${baseUrl}/model/m2-nervous-system-states`,
      lastModified: new Date(PAGE_DATES['/model/m2-nervous-system-states']),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
    ...
    {
      url: `${baseUrl}/model/m4-awareness-capacities`,
      lastModified: new Date(PAGE_DATES['/model/m4-awareness-capacities']),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
