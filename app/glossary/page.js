...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "Complexity markers are linguistic indicators of self-awareness, perspective-taking, and emotional differentiation. They predict the capacity to return to baseline when challenged, which TEG-Blue's core testable claim identifies as the key variable in relational and behavioral outcomes.",
  },
];
...
const GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "Regulatory state when threat is perceived. Sympathetic or dorsal vagal dominant. Enables defense, boundary-setting, and survival responses. Characterized by narrow perceptual field, reduced empathy access, cognitive rigidity, and reduced heart rate variability. Accurate adaptation to perceived danger.",
    tags: ["F1", "polyvagal", "regulatory-state"],
    framework: 1,
  },
  {
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The duration each mode was designed to operate. Connection has no design limit — it is baseline. Protection was designed for minutes to hours, maximum days. Control is time-limited — a tool. Domination is rare — last resort only. Design duration makes chronic modes visible as structural problems: not 'this person is angry' but 'this person has been in Protection for twenty years.' The gap between design duration and actual duration is the measure of what Biological Restoration's absence has cost.",
    tags: ["F1", "architecture", "regulation"],
    framework: 1,
  },
  {
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The regulatory state the nervous system returns to when no threat is present and Biological Restoration has completed. In a system with functioning Biological Restoration, baseline is Connection Mode — but baseline is defined by the return, not by the mode. Baseline is not the absence of activation; it is the home position of a fluid compass. A nervous system with functioning Biological Restoration returns to baseline after every activation. A nervous system without Biological Restoration never fully returns — its effective baseline shifts progressively toward the chronic mode, making elevated activation feel normal.",
  ...
  // ===== F9: NEURODIVERGENCE AS NERVOUS SYSTEM VARIATION =====
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The characteristic way a nervous system processes sensory input, attention, emotion, and social information. Neurodivergence is a difference in regulatory rhythm — variation in how the nervous system naturally operates. These are not deficits but different configurations across domains: attention (variable intensity vs sustained), sensory processing (low/high threshold), emotional intensity (high amplitude, extended processing), social processing (explicit vs intuitive), cognitive style (associative vs linear), and motor regulation (stimming, movement needs).",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "Linguistic and behavioral signs of self-awareness, perspective-taking, and emotional differentiation. Preliminary evidence suggests they predict capacity to return to baseline when challenged.",
