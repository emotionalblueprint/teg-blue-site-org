...
const GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The bifurcation point in the activation cycle where the path splits. When the nervous system mobilizes for threat, it was designed to complete the cycle: mobilize, respond, and restore. The Fork is the moment where that process either runs — Biological Restoration completes, the compass returns to baseline — or cognition overrides it, the cycle stays open, and everything from F2 to F7 describes what happens next. Named in F1 and referenced in M3 as the physiological pivot of the entire system. The Fork is why Biological Restoration is the mechanism on which the entire twelve-framework system turns.",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The ability to return to baseline after being pushed into Protection or Control by challenge or threat. TEG-Blue's core hypothesis is that this capacity — not current state — predicts relational outcomes.",
    tags: ["core-concept", "measurement"],
  },
