...
const GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    tags: ["F1", "development", "attachment"],
    framework: 1,
  },
  {
    slug: "feeling-equals-being",
    title: "Feeling = Being",
    type: "concept",
    status: "proposed",
  ...
  // ===== F3: THE LOGIC LAYER =====
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The cognitive regulation layer whose primary function is to maintain internal coherence under pressure. In regulated states: integrates emotion with thought, tolerates ambiguity, revises beliefs when evidence changes. In defensive states: simplifies and stabilizes, protects identity structure, filters perception through identity preservation. The Logic Layer does not pursue truth as its primary goal — it pursues stability. Understanding second. Regulation first.",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "Within TEG-Blue, cognitive dissonance is defined as a regulatory stress response, not a reasoning failure. The discomfort of contradiction is the nervous system signaling threat. When reality contradicts the protective identity structure and cognition cannot integrate the contradiction without threatening coherence, dissonance reduction restores subjective stability — people prefer coherent narratives over ambiguous instability.",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "What happens when beliefs fuse with the protective identity structure (F2). Contradiction is no longer processed as information — it becomes risk to identity, belonging, and status. The mechanism: belief becomes part of 'who I am' → challenge to belief = challenge to self → nervous system activates defense → information rejected to preserve coherence → rejection feels like 'seeing clearly' rather than defending. This is why 'being wrong' can feel existential.",
  ...
  // ===== F8: SELF-RECONNECTION =====
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The five conditions that enable capacity development: (1) Felt Safety — nervous system regulation sufficient for change; (2) Accurate Mirroring — being seen as one actually is; (3) Discomfort Tolerance — capacity to stay present with difficulty (grief, fear, uncertainty); (4) Permission — internal/external acceptance of imperfection; (5) Time — accumulated experience rather than single insight. These conditions must be present before significant repair can occur safely.",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "Different pathways through which people access what exists before adaptation reshapes it: (1) Somatic Awareness — body sensation, for those disconnected from feeling; (2) Emotional Honesty — felt emotion, for those who perform emotions; (3) Values Clarification — authentic wanting, for those who don't know what they want; (4) Joy and Aliveness — spontaneous energy, for those who lost access to pleasure; (5) Self-Reparenting — internal relationship, for those with harsh inner critic; (6) Pattern Mapping — cognitive understanding, for those who need to understand before feeling; (7) Grief Work — loss processing, for those avoiding mourning.",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The five phases of capacity development: (1) Pre-contemplation — protective patterns invisible, fusion complete; (2) Recognition — patterns become visible, grief emerges; (3) Ambivalence — oscillation between old patterns and new capacity; (4) Active Development — experiments with authenticity; (5) Integration — protective patterns as choice rather than compulsion. Repair is not linear — oscillation between phases is normal. Regression during repair is not failure; it is the nervous system's natural process of testing and consolidating.",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "Why protective identity structures resist change: (1) Fused with Survival — at nervous system level, protective patterns are fused with belonging, safety, and identity; (2) Reinforced by Success — professional achievement and relationships built on performance strengthen them; (3) Identity Fusion — after years of living from protective patterns, 'this is just who I am' reflects genuine inability to perceive separation; (4) Relational Cost Anticipation — nervous system accurately predicts that repair may cost relationships built on performance. Resistance should be respected, not overcome — the system is assessing whether repair is safe.",
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "Chronic activation of Protection, Control, or Domination where the nervous system gets stuck outside Connection. When a Chronic Pattern sets in repeatedly without resolution, the system can become stuck in Pattern B. The baseline shifts toward chronic defense; Pattern A becomes difficult to access. This is not 'personality disorder' — it is chronic defensive activation, treatable through sustained safety provision.",
    tags: ["F1", "dysregulation", "trauma"],
    framework: 1,
  },
  {
