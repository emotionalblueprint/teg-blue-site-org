...
const GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    type: "concept",
    status: "proposed",
    definition: "The three-capacity model showing what happens to 'empathy' during escalation. The three awareness capacities diverge — they do not move together: Reading Emotions (RE) does not collapse but redirects from understanding to management to weaponization. Emotional Resonance (ER) is what collapses — the felt connection channel progressively shuts down. Self-Emotional Awareness (SEA) was never there — it is the precondition for the escalation pathway, not a consequence. The dangerous configuration: sharp RE + collapsed ER + absent SEA. The person reads you perfectly, cannot feel your pain, and has no internal signal telling them any of this is happening. This explains why chronic Control mimics healthy Connection, why victims are not believed, and why empathy appeals fail at later stages.",
