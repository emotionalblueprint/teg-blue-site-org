...
export const metadata = {
  ...
  description: "Open science platform for TEG-Blue research. Validation findings, theoretical foundations, and collaboration opportunities.",
  alternates: {
    ...
    >
      ...
      >
        ...
        <header style={{ marginBottom: 32 }}>
          ...
          >
            Anna Paretas-Artacho · February 2026
          </p>
          <p
            style={{
              fontSize: 15,
        ...
        >
          ...
          >
            If your expertise connects to any of the research directions above, we'd welcome a conversation.
          </p>
