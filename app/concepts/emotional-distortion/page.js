...
import * as content from "@/src/content/concepts/c7-content";

const concept = getConceptBySlug("emotional-distortion");
...
export default function EmotionalDistortionPage() {
