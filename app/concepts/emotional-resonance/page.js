...
import * as content from "@/src/content/concepts/c8-er-content";

const concept = getConceptBySlug("emotional-resonance");
...
export default function EmotionalResonancePage() {
