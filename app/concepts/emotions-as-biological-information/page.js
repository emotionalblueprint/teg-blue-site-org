...
import * as content from "@/src/content/concepts/c1-content";

const concept = getConceptBySlug("emotions-as-biological-information");
...
export default function EmotionsAsBiologicalInformationPage() {
  return (
    <>
      <script
