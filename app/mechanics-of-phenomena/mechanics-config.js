...
export const SERIES = [
  {
    ...
    pieces: [
      ...
      {
        number: 4,
        slug: "04-why-wrong-people-in-charge",
        title: "Why We Keep Putting the Wrong People in Charge",
        subtitle: "A diagnostic for the baffled, the historically literate, and the ones who keep watching it happen again",
        metaDescription: "Why confidence keeps getting mistaken for competence \u2014 the regulatory architecture behind compass outsourcing, from baboon cortisol to political leadership. A diagnostic from TEG-Blue.",
        connection: "F7 Compass Outsourcing / M2 Operating Modes / F4 Collective Regulation / F3 Cognitive Replacement",
        readingTime: 14,
        sections: [
          { id: "confidence-competence", label: "Confidence vs competence" },
          { id: "logic-or-irrationality", label: "A regulatory logic" },
          { id: "worse-when-frightened", label: "Worse when frightened" },
          { id: "smart-people-too", label: "Smart people do it too" },
          { id: "defend-bad-leaders", label: "Defending bad leaders" },
          { id: "design-flaw", label: "Design flaw or survival logic?" },
          { id: "can-this-change", label: "Can this change?" },
          { id: "framework-behind", label: "Framework behind these answers" },
        ],
      },
