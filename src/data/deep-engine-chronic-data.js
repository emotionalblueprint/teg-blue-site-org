...
export const DEEP_ENGINE_CHRONIC_FORMATION_META = {
  ...
  domination: {
    ...
    plainChronic: "Power becomes identity — force is trusted when nothing else works",
    chronicColor: "#ff404a",
  },
  shutdown: {
    chronicConfig: "Shutdown",
    chronicConfigDetail: "Shutdown",
    plainChronic: "Mobilising feels unavailable — collapse becomes the return point",
    chronicColor: "#a1adbf",
  },
};
