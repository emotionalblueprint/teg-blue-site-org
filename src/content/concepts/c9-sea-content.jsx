...
export const body = (
  <>
    ...
    <p style={prose}>
      Self-Emotional Awareness — SEA — is the capacity to notice this.
    </p>
    <p style={prose}>
    ...
    <p style={prose}>
      When SEA is available, we can catch the moment. We feel defensive in a
      conversation, and something in us says:{" "}
    ...
    <p style={prose}>
      SEA is not automatic. It forms — or doesn't — based on what happened
      around us when we were very young.
    </p>
    <p style={prose}>
      ...
      When the child's signals were ignored or contradicted, SEA doesn't form.
      Not because the child was incapable. Because the conditions weren't there.{" "}
      <Link href="/concepts/awareness-teaches-awareness" style={conceptLink}>
        {"\u2192"} Awareness Teaches Awareness
      </Link>
    </p>
    <p style={prose}>
      When SEA is absent, we don't experience a gap. We just experience the
    ...
    <p style={prose}>
      Without SEA, when we feel bad, we don't think "I feel bad." We think
    ...
    <p style={prose}>
      ...
      have SEA. Intelligence builds better explanations. Without SEA, cognition
      fills the void with narratives that feel true but aren't connected to
      what's actually happening in the body. We can talk about vulnerability
      without being vulnerable. We can analyse our patterns with brilliant
      precision and change none of them.{" "}
    ...
    <p style={prose}>
      SEA is not a psychological luxury. In relationships, it is what lets us
    ...
    <p style={prose}>
      SEA is the difference between knowing about ourselves and actually knowing
      ourselves.
    </p>
    ...
    <p style={prose}>
      SEA was always meant to come online. It is a biological capacity — part of
