  ...
  return (
    ...
    >
      ...
      >
        ...
        {" — "}
        Founder and creator of TEG-Blue, working independently from Barcelona. 25+ years of professional practice in visual communication and systems thinking. TEG-Blue developed over two years as an integrative architecture synthesizing 145+ theoretical contributions from 41 research traditions across 24 scientific domains.{" "}
        <Link
          href="/about"
