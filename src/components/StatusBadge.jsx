...
import { SPECTRUM, STATUS, hexToRgba, FONT } from "../styles/tokens";
...
const STATUS_MAP = {
  ...
  // Verification statuses (for TEG-Blue original content)
  "draft":              { color: STATUS.draft, label: "Draft", description: "Early work — structure may change" },
  ...
  "community-reviewed": { color: STATUS.reviewed, label: "Community Reviewed", description: "Verified by external researcher" },
